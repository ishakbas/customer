...
import 'package:myservice_customer/screens/booking/component/confirm_booking_dialog.dart';
import 'package:myservice_customer/screens/map/map_screen.dart';
import 'package:myservice_customer/screens/service/package/package_info_bottom_sheet.dart';
    ...
    if (!widget.data.serviceDetail!.isFreeService)
      return Column(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              if (appliedCouponData != null)
                TextButton(
                  child: Text(language.lblRemoveCoupon, style: secondaryTextStyle(color: primaryColor)),
                  onPressed: () {
          ...
          if (appliedCouponData == null) 16.height,
          Container(
            padding: EdgeInsets.all(16),
            width: context.width(),
            decoration: boxDecorationDefault(color: context.cardColor),
