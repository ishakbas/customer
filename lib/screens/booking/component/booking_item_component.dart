...
import 'package:myservice_customer/screens/booking/component/edit_booking_service_dialog.dart';
...
import 'package:myservice_customer/utils/extensions/num_extenstions.dart';
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    8.width,
                    Text(
                      "${formatDate(widget.bookingData.date.validate(), format: DATE_FORMAT_2)} ${language.at} " + buildTimeWidget(bookingDetail: widget.bookingData),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: boldTextStyle(
                                size: 12,
                                color: widget.bookingData.paymentStatus == SERVICE_PAYMENT_STATUS_ADVANCE_PAID || (widget.bookingData.paymentStatus == SERVICE_PAYMENT_STATUS_PAID || widget.bookingData.paymentStatus == PENDING_BY_ADMIN)
                                    ? Colors.green
                                    : Colors.red),
                          ),
                        ],
