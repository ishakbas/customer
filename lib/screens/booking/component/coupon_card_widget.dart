import 'package:myservice_customer/component/dotted_line.dart';
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text.rich(
                    TextSpan(
                      children: [
                        ...
                        TextSpan(
                          text:
                              "${isCurrencyPositionLeft ? appStore.currencySymbol : ''}${calculateCouponDiscount(couponData: data, price: servicePrice.validate()).toStringAsFixed(DECIMAL_POINT).formatNumberWithComma()}${isCurrencyPositionRight ? appStore.currencySymbol : ''}",
                  ...
                  Text(
                    "${language.lblExpiryDate} ${DateFormat(DATE_FORMAT_2).format(DateTime.parse(data.expireDate.validate()))}",
