...
import 'package:myservice_customer/screens/blog/blog_repository.dart';
import 'package:myservice_customer/screens/blog/component/blog_detail_header_component.dart';
                      ...
                      if (data.blogDetail!.createdAt.validate().isNotEmpty)
                        Row(
                          children: [
                            ...
                            Text("${formatDate(data.blogDetail!.createdAt.validate(), format: DATE_FORMAT_2)}", style: primaryTextStyle(size: 12), maxLines: 2, overflow: TextOverflow.ellipsis).expand(),
                          ],
                        ).expand(),
