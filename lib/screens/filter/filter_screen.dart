...
import 'package:myservice_customer/screens/filter/component/filter_category_component.dart';
import 'package:myservice_customer/screens/filter/component/filter_price_component.dart';
import 'package:myservice_customer/screens/filter/component/filter_provider_component.dart';
        ...
        children: [
          ...
          Observer(
            builder: (_) => Container(
              ...
              child: Row(
                children: [
                  if (filterStore.providerId.validate().isNotEmpty || filterStore.categoryId.validate().isNotEmpty
