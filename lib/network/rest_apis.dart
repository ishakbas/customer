...
import 'package:myservice_customer/model/base_response_model.dart';
import 'package:myservice_customer/model/booking_data_model.dart';
import 'package:myservice_customer/model/booking_detail_model.dart';
import 'package:myservice_customer/model/booking_list_model.dart';
import 'package:myservice_customer/model/booking_status_model.dart';
import 'package:myservice_customer/model/category_model.dart';
import 'package:myservice_customer/model/city_list_model.dart';
...
import 'package:myservice_customer/model/get_my_post_job_list_response.dart';
import 'package:myservice_customer/model/login_model.dart';
import 'package:myservice_customer/model/notification_model.dart';
import 'package:myservice_customer/model/post_job_detail_response.dart';
import 'package:myservice_customer/model/provider_info_response.dart';
import 'package:myservice_customer/model/provider_list_model.dart';
import 'package:myservice_customer/model/service_data_model.dart';
import 'package:myservice_customer/model/service_detail_response.dart';
import 'package:myservice_customer/model/service_response.dart';
import 'package:myservice_customer/model/service_review_response.dart';
import 'package:myservice_customer/model/state_list_model.dart';
import 'package:myservice_customer/model/user_data_model.dart';
import 'package:myservice_customer/model/user_wallet_history.dart';
import 'package:myservice_customer/model/verify_transaction_response.dart';
import 'package:myservice_customer/network/network_utils.dart';
import 'package:myservice_customer/screens/dashboard/dashboard_screen.dart';
import 'package:myservice_customer/utils/colors.dart';
import 'package:myservice_customer/utils/common.dart';
...
import 'package:myservice_customer/utils/one_signal_utils.dart';
...
Future<ConfigurationResponse> getAppConfigurations({bool isCurrentLocation = false, double? lat, double? long}) async {
  try {
    ConfigurationResponse? data = ConfigurationResponse.fromJson(await handleResponse(await buildHttpResponse('configurations?is_authenticated=${appStore.isLoggedIn.getIntBool()}', method: HttpMethodType.GET)));
    ...
    if (data.otherSettings != null) {
      ...
      otherSettingStore.setPostJobRequestEnable(otherSetting.postJobRequest.validate());
      ...
      otherSettingStore.setTestWithoutKey(otherSetting.testWithoutKey.validate());
      ...
      if (otherSetting.chatGptKey.validate().isNotEmpty) {
        ...
        log('chatGPTAPIkey: $chatGPTAPIkey');
      }

      compareValuesInSharedPreference(FORCE_UPDATE_USER_APP, otherSetting.forceUpdateUserApp);
      compareValuesInSharedPreference(USER_APP_MINIMUM_VERSION, otherSetting.userAppMinimumVersion);
      compareValuesInSharedPreference(USER_APP_LATEST_VERSION, otherSetting.userAppLatestVersion);
      appStore.setEnableUserWallet(otherSetting.enableUserWallet.validate());
      compareValuesInSharedPreference(IS_ADVANCE_PAYMENT_ALLOWED, otherSetting.isAdvancedPaymentAllowed.validate());
    }

    if (appStore.isLoggedIn && isOneSignalInitialize == false) {
      initializeOneSignal();
    }
