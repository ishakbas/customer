...
BookingAmountModel finalCalculations({
  ...
  data.finalSubTotal = (data.finalTotalServicePrice - data.finalDiscountAmount - data.finalCouponDiscountAmount + data.finalServiceAddonAmount).toStringAsFixed(DECIMAL_POINT).toDouble();
